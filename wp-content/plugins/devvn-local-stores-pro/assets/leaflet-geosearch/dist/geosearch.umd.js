!function (t, e) {
    ...
    var p, d = 13, f = 40, m = 38, v = [d, 27, f, m, 37, 39], y = function () {
        ...
        return e.onFocus = function () {
            ...
            try {
                var e = this;
                return u(t), h(r = e.container, "error"), c(r, "pending"), Promise.resolve(e.handleSubmit({query: e.input.value})).then(function () {
        ...
        keepResult: !1,
        updateMap: !0
    }, x = "Leaflet must be loaded before instantiating the GeoSearch control", E = {
        options: r({}, b), classNames: r({}, b.classNames), initialize: function (t) {
            var n, o, s, i, u = this;
            ...
            }, void 0 === (o = this.options.autoCompleteDelay) && (o = 250), void 0 === s && (s = !1), function () {
                for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++) e[r] = arguments[r];
                i && clearTimeout(i), i = setTimeout(function () {
                    i = null, s || n.apply(void 0, e)
                }, o), s && !i && n.apply(void 0, e)
            ...
            try {
                ...
                var r = t.target.value, n = e.options.provider, o = function () {
                    if (r.length) return Promise.resolve(n.search({query: r})).then(function (t) {
        ...
        return r.endpoint = function (t) {
            ...
            try {
                ...
                return Promise.resolve((e = s.endpoint({
                    query: o,
                    jsonp: i
                }), r = i, n = a("script", null, document.body), n.setAttribute("type", "text/javascript"), new Promise(function (t) {
                    window[r] = function (e) {
