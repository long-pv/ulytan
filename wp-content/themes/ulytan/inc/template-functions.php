...
add_action('admin_footer', function () {
	...
	<script type="text/javascript">
		jQuery(document).ready(function ($) {
			...
			$('#menu-posts-local_store .wp-submenu li a[href="edit.php?post_type=local_store"]').text('Toàn bộ văn phòng');
			$('#menu-posts-local_store .wp-submenu li a[href="post-new.php?post_type=local_store"]').text('Thêm mới văn phòng');
		});
	</script>
	<?php
});
				...
				if ($page_id == 'trang_tai_lieu') {
					fputcsv(
						...
						[
							...
							in_array(convert_to_slug('Bán vé máy bay'), $services) ? 'x' : '',
							in_array(convert_to_slug('Giấy khám sức khoẻ'), $services) ? 'x' : '',
							in_array(convert_to_slug('Mục đích khác'), $services) ? 'x' : '',
