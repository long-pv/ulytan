...
/**
 * Template name: Loại page dịch vụ
 * Template_name: Dịch thuật công chứng (bỏ)
					...
					<div class="row justify-content-center row_24">
						...
						foreach ($achieve_brand_image as $item):
							if ($item['image']) {
								?>
								<div class="col-md-6">
									<img class="achieve_brand_img" src="<?php echo $item['image']; ?>"
										alt="<?php echo $item['tieu_de_anh']; ?>">
									<?php
									if ($item['tieu_de_anh']) {
										?>
							...
							<?php if ($name): ?>
								<div class="info_customer">
									<div class="testimonials">
										<svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#ebebed"
									...
									<div class="row no-gutters">
										<div class="col-4">
											<div class="avatar_box">
												<img class="w-100 avatar object-fit-cover border rounded"
													src="<?php echo $avatar; ?>">
											</div>
										</div>
										<div class="col-8">
						...
						<div class="row justify-content-center">
							<div class="col-md-10 col-lg-8">
								<div class="price_table_img_block">
									<img class="price_table_img" src="<?php echo $item['image']; ?>"
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="image_advisory_wrap">
								<img class="image_advisory"
									src="<?php echo get_template_directory_uri() . '/assets/images/image_advisory.png'; ?>"
									alt="image advisory">
							</div>
						</div>
					</div>
...
<section class="secSpace--top">
	<div class="container">
		...
		<div class="reaction_buttons landingpage_share_mxh_wrap">
			<button class="reaction_button_item like_button <?php echo $current_reaction === 'like' ? 'active' : ''; ?>"
			...
			<!-- facebook -->
			<a class="reaction_button_item single_post_share_mxh_icon"
			...
			<!-- Twitter (X) -->
			<a class="reaction_button_item single_post_share_mxh_icon"
				href="https://twitter.com/home?status=<?php echo the_permalink(); ?>"
				onclick="window.open(this.href, this.target, 'width=500,height=500'); return false;">
				<svg xmlns="http://www.w3.org/2000/svg"
			...
			<!-- linkedin -->
			<a class="reaction_button_item single_post_share_mxh_icon"
				href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo $share_link; ?>&title=text"
				onclick="window.open(this.href, this.target, 'width=500,height=500'); return false;">
				<svg xmlns="http://www.w3.org/2000/svg"
			...
			<!-- copy link -->
			<a href="javascript:void(0);" onclick="copyToClipboard('#copy2')"
				class="reaction_button_item single_post_share_mxh_icon">
			...
			<button
				class="reaction_button_item dislike_button <?php echo $current_reaction === 'dislike' ? 'active' : ''; ?>"
				data-post-id="<?php echo $post_id; ?>">
				<span class="reaction_buttons_icon">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
						<path
...
if ($hien_thi_popup != "0"):
	?>
	<div class="modal modal_landing fade" id="modal_landing" tabindex="-1" aria-labelledby="exampleModalLabel"
		aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-footer justify-content-center">
					<div class="d-flex justify-content-center">
						<input type="submit" class="contact_submit contact_submit_fake landingpage_popup_btn_submit"
							value="Đăng ký ngay">
					</div>
				</div>
			</div>
...
<div class="modal modal_lien_he fade show" id="modal_lien_he" tabindex="-1" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="editor">
					<p style="text-align: center;"><span style="color: #339966;"><span style="font-size: 48px;">Thành
								công</span></span></p>
					<p style="text-align: center;"><strong>Bộ phận tư vấn của chúng tôi sẽ liên hệ với bạn trong thời
							gian sớm nhất.</strong></p>
					<p>&nbsp;</p>
					<p style="text-align: center;"><span style="font-size: 28px;"><strong>Chúc hợp tác thành
								công!</strong></span></p>
				</div>
