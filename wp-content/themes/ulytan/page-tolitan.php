...
/**
 * Template name: Loai page tác giả
 * Template_name: Page tolitan (bỏ)
						...
						<div class="subtitle">
							...
							<div>
								<svg width="121" height="3" viewBox="0 0 121 3" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<defs>
										<linearGradient id="paint0_linear_2921_1027" x1="-0.000611732" y1="1.27167" x2="121.001"
											y2="1.20832" gradientUnits="userSpaceOnUse">
				...
				<?php if ($author_image): ?>
					<div class="col-md-6 col-lg-4">
						<div class="banner_landing_img_wrap">
							<img class="banner_landing_img" src="<?php echo $author_image; ?>"
		...
		<div class="container">
			<div class="row row_24 align-items-center">
				<?php if ($startup_story_image): ?>
					<div class="col-md-6 col-lg-4">
						<figure>
							<img class="img-fluid" src="<?php echo $startup_story_image; ?>"
								alt="<?php echo $startup_story_title; ?>">
		...
		<div class="container">
			<div class="row row_24 align-items-center">
				<?php if ($achievements_image): ?>
					<div class="col-md-6 col-lg-6">
						<figure>
							<img class="img-fluid" src="<?php echo $achievements_image; ?>"
								alt="<?php echo $achievements_title; ?>">
						</figure>
					</div>
				<?php endif; ?>
				<div class="col-md-6 col-lg-6">
					...
					<div class="row">
						<?php foreach ($achievements_gallery as $image_id): ?>
							<div class="col-6 col-lg-4">
								<img class="img-fluid mt-4" src="<?php echo esc_url($image_id['url']); ?>"
									alt="<?php echo esc_attr($image_id['alt']); ?>" />
							</div>
						<?php endforeach; ?>
					</div>
				</div>
...
if ($posts_list):
	...
	<section class="section_posts secSpace">
		<div class="container">
			...
			<?php if ($posts_list): ?>
				<?php foreach ($posts_list as $index => $post):
					setup_postdata($post); ?>
			...
			<?php if ($project_list): ?>
				<div class="project_list_slider">
					<?php foreach ($project_list as $item): ?>
						<div class="item">
							<div class="image_bg">
								<img class="w-100 object-fit-cover" src="<?php echo esc_url($item['image_bg']); ?>"
							...
							<div class="wrap-content">
								...
								<div>
									<img class="d-inline-flex img-fluid" src="<?php echo esc_url($item['logo']); ?>"
										alt="<?php echo esc_attr($item['title']); ?>" />
								</div>
						...
						<div class="item">
							<div class="icon">
								<a href="<?php echo $item['link']; ?>" target="_blank" class="link">
									<img class="img-fluid" src="<?php echo esc_url($item['icon']); ?>"
										alt="<?php echo esc_attr($item['title']); ?>" />
								</a>
							</div>
							<h3 class="title h6">
