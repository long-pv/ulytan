				...
				<div class="row row_24">
					<div class="col-lg-3">
						<div class="page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="full_name"
								placeholder="Ví du:Phạm Kim Dung">
						</div>
					</div>
					<div class="col-lg-3">
						<div class="page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="birthdate"
								placeholder="Điền dưới dạng: Ngày/Tháng/Năm">
						</div>
					</div>
					<div class="col-lg-3">
						<div class="page_ctv_form_group">
					...
					<div class="col-lg-3">
						<div class="page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="email"
								placeholder=" Ví dụ: sale@ulytan.com">
						</div>
					</div>
					...
					<div class="col-lg-3 page_ctv_step_6" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="graduation_school"
								placeholder="ĐH tốt nghiệp gần đây nhất">
						</div>
					</div>
					<div class="col-lg-3 page_ctv_step_7" style="display:none;">
						<div class=" page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="graduation_year"
								placeholder=" Điền dưới dạng Ngày/Tháng/Năm">
						</div>
					</div>
					<div class="col-lg-3 page_ctv_step_8" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="translation_unit_name"
								placeholder=" Ví dụ: Dịch thuật Ulytan">
						</div>
					</div>
					<div class="col-lg-3 page_ctv_step_9" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="dictionary"
								placeholder="Ví dụ: Lạc Việt">
						</div>
					</div>
						...
						<div class="page_ctv_form_group">
							...
							<div class="custom_dropdown">
								...
								<div class="custom_dropdown_menu">
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Anh">
										Tiếng Anh</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Nga">
										Tiếng Nga</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Pháp">
										Tiếng Pháp</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Đức">
										Tiếng Đức</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Nhật">
										Tiếng Nhật</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Hàn Quốc">
										Tiếng Hàn Quốc</label>
									<label><input type="checkbox" name="registration_language[]"
											value="Tiếng Trung Quốc"> Tiếng Trung Phồn thể</label>
									<label><input type="checkbox" name="registration_language[]"
											value="Tiếng Trung Quốc"> Tiếng Trung giản thể</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Nga">
										Tiếng Nga</label>
									<label><input type="checkbox" name="registration_language[]"
											value="Tiếng Tây Ba Nha"> Tiếng Tây Ba Nha</label>
									<label><input type="checkbox" name="registration_language[]"
											value="Tiếng Bồ Ba Nha"> Bồ Ba Nha</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Italia">
										Tiếng Italia</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Séc">
										Tiếng Séc</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Bỉ"> Tiếng
										Bỉ </label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Canada ">
										Tiếng Canada </label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Hà Lan">
										Tiếng Hà Lan</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng La Tinh">
										Tiếng La Tinh</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Ba Lan">
										Tiếng Ba Lan</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Ucraina">
										Tiếng Ucraina</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Bungari">
										Tiếng Bungari</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Belarus">
										Tiếng Belarus</label>
									<label><input type="checkbox" name="registration_language[]"
											value="Tiếng Thổ Nhĩ Kỳ"> Tiếng Thổ Nhĩ Kỳ</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng A Rập">
										Tiếng A Rập"</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Lào">
										Tiếng Lào</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Thái Lan">
										Tiếng Thái Lan</label>
									<label><input type="checkbox" name="registration_language[]"
											value="Tiếng Campuchia"> Tiếng Campuchia</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng Myanmar ">
										Tiếng Myanmar</label>
									<label><input type="checkbox" name="registration_language[]" value="Tiếng khác">
										Tiếng khác</label>
								</div>
					...
					<div class="col-lg-3 page_ctv_step_11" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<div class="custom_dropdown">
								...
								<div class="custom_dropdown_menu">
									<!-- how_do_you_know -->
									<label><input type="checkbox" name="how_do_you_know[]" value="Bạn bè giới thiệu">
										Bạn bè giới thiệu</label>
									<label><input type="checkbox" name="how_do_you_know[]" value="Facebook">
										Facebook</label>
									<label><input type="checkbox" name="how_do_you_know[]" value="Google search"> Google
										search</label>
									<label><input type="checkbox" name="how_do_you_know[]" value="Email"> Email</label>
									<label><input type="checkbox" name="how_do_you_know[]" value="Youtube">
										Youtube</label>
									<label><input type="checkbox" name="how_do_you_know[]" value="Báo chí"> Báo
										chí</label>
					...
					<div class="col-lg-3 page_ctv_step_12" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<div class="custom_dropdown">
								<div class="custom_dropdown_button">Chọn tùy chọn</div>
								<div class="custom_dropdown_menu">
									<label><input type="checkbox" name="translation_skill[]" value="Dịch xuôi"> Dịch
										xuôi</label>
									<label><input type="checkbox" name="translation_skill[]" value="Dịch ngược"> Dịch
										ngược</label>
									<label><input type="checkbox" name="translation_skill[]" value="Cả xuôi và ngược">Cả
										xuôi và ngược</label>
								</div>
							...
							<div class="custom_dropdown">
								...
								<div class="custom_dropdown_menu">
									<div class="group-language">
										...
										<div class="item">
											<label><input type="checkbox" name="language_speciality[]"
													value="Luật kinh tế"> Luật kinh tế</label>
											<label><input type="checkbox" name="language_speciality[]"
													value="Luật dân sự"> Luật dân sự</label>
											<label><input type="checkbox" name="language_speciality[]"
													value="Luật quốc tế"> Luật quốc tế</label>
										</div>
									</div>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Tài chính - Ngân hàng"> Tài chính - Ngân hàng</label>

											<label><input type="checkbox" name="language_speciality[]" value="Kế toán">
												Kế toán</label>

											<label><input type="checkbox" name="language_speciality[]" value="Bảo hiểm">
												Bảo hiểm</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]" value="Dược học">
												Dược học</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]" value="Sản khoa">
												Sản khoa</label>

											<label><input type="checkbox" name="language_speciality[]" value="Nội khoa">
												Nội khoa</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Ngoại khoa"> Ngoại khoa</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Y học cổ truyền"> Y học cổ truyền</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Răng-hàm-mặt"> Răng-hàm-mặt</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Điều dưỡng"> Điều dưỡng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật Y học"> Kỹ thuật Y học</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Dinh dưỡng"> Dinh dưỡng</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật máy tính"> Kỹ thuật máy tính</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Truyền thông và mạng máy tính"> Truyền thông và mạng máy
												tính</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật phần mềm"> Kỹ thuật phần mềm</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Hệ thống thông tin"> Hệ thống thông tin</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Toán-tin ứng dụng"> Toán-tin ứng dụng</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật điện - điện tử"> Kỹ thuật điện - điện tử</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật điều khiển tự động hóa"> Kỹ thuật điều khiển tự động
												hóa</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật điện tử truyền thông"> Kỹ thuật điện tử truyền
												thông</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Hệ thống điện"> Hệ thống điện</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Nhiệt điện"> Nhiệt điện</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Thủy điện"> Thủy điện</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Năng lượng hạt nhân"> Năng lượng hạt nhân</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Cơ kĩ thuật"> Cơ kĩ thuật</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ kĩ thuật ô tô"> Công nghệ kĩ thuật ô tô</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kĩ thuật cơ khí"> Kĩ thuật cơ khí</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kĩ thuật hàng không"> Kĩ thuật hàng không</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kĩ thuật tàu thủy"> Kĩ thuật tàu thủy</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ chế tạo máy"> Công nghệ chế tạo máy</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ kĩ thuật cơ điện tử"> Công nghệ kĩ thuật cơ điện
												tử</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kĩ thuật nồi hơi"> Kĩ thuật nồi hơi</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kĩ thuật nhiệt nóng"> Kĩ thuật nhiệt nóng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kĩ thuật nhiệt lạnh"> Kĩ thuật nhiệt lạnh</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Vật liệu Polyme"> Vật liệu Polyme</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Vật liệu Silicat"> Vật liệu Silicat</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Vật liệu kim loại - Hợp kim"> Vật liệu kim loại - Hợp
												kim</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật sinh học"> Kỹ thuật sinh học</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật môi trường"> Kỹ thuật môi trường</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ thực phẩm"> Công nghệ thực phẩm</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ sinh học"> Công nghệ sinh học</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Hóa vô cơ"> Hóa vô cơ</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Hóa hữu cơ"> Hóa hữu cơ</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Hóa phân tích"> Hóa phân tích</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ in và xuất bản"> Công nghệ in và xuất bản</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ hóa dầu"> Công nghệ hóa dầu</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật mỏ"> Kỹ thuật mỏ</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật tuyển khoáng"> Kỹ thuật tuyển khoáng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật địa vật lí"> Kỹ thuật địa vật lí</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật trắc địa bản đồ"> Kỹ thuật trắc địa bản đồ</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Kiến trúc"> Kiến trúc</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Quy hoạch vùng và đô thị"> Quy hoạch vùng và đô thị</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật công trình xây dựng"> Kỹ thuật công trình xây
												dựng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật xây dựng công trình giao thông"> Kỹ thuật xây dựng
												công trình giao thông</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật xây dựng công trình cầu đường"> Kỹ thuật xây dựng
												công trình cầu đường</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Quản lý xây dựng"> Quản lý xây dựng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kinh tế xây dựng"> Kinh tế xây dựng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật công trình biển"> Kỹ thuật công trình biển</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Vật lý-Kỹ thuật"> Vật lý-Kỹ thuật</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]" value="Toán học">
												Toán học</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Khoa học đất"> Khoa học đất</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Vật lý học"> Vật lý học</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Khoa học cây trồng"> Khoa học cây trồng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Bảo vệ thực vật"> Bảo vệ thực vật</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Nông nghiệp"> Nông nghiệp</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ rau quả và cảnh quan"> Công nghệ rau quả và cảnh
												quan</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ sau thu hoạch"> Công nghệ sau thu hoạch</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Chăn nuôi"> Chăn nuôi</label>

											<label><input type="checkbox" name="language_speciality[]" value="Thú y">
												Thú y</label>

											<label><input type="checkbox" name="language_speciality[]" value="Lâm sinh">
												Lâm sinh</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kinh tế nông nghiệp"> Kinh tế nông nghiệp</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Quản lý tài nguyên rừng"> Quản lý tài nguyên rừng</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ chế biến lâm sản"> Công nghệ chế biến lâm
												sản</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Nuôi trồng thủy sản"> Nuôi trồng thủy sản</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật tài nguyên nước"> Kỹ thuật tài nguyên nước</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật công trình biển"> Kỹ thuật công trình biển</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật thủy điện và năng lượng tái tạo"> Kỹ thuật thủy điện
												và năng lượng tái tạo</label>

											<label><input type="checkbox" name="language_speciality[]" value="Thủy văn">
												Thủy văn</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Cấp thoát nước"> Cấp thoát nước</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Chính trị học"> Chính trị học</label>

											<label><input type="checkbox" name="language_speciality[]" value="Lịch sử">
												Lịch sử</label>

											<label><input type="checkbox" name="language_speciality[]" value="Nhân học">
												Nhân học</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Tâm lý học"> Tâm lý học</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Triết học"> Triết học</label>

											<label><input type="checkbox" name="language_speciality[]" value="Văn học">
												Văn học</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Xã hội học"> Xã hội học</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Công nghệ đa phương tiện"> Công nghệ đa phương tiện</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Quan hệ công chúng"> Quan hệ công chúng</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Bảo hộ lao động"> Bảo hộ lao động</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Quản trị nhân lực"> Quản trị nhân lực</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Điều tra trinh sát"> Điều tra trinh sát</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Điều tra hình sự"> Điều tra hình sự</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Quản lý nhà nước về an ninh trật tự"> Quản lý nhà nước về an
												ninh trật tự</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Kỹ thuật hình sự"> Kỹ thuật hình sự</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Quản lý giáo dục cải tạo phạm nhân"> Quản lý giáo dục cải tạo
												phạm nhân</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Phòng cháy chữa cháy"> Phòng cháy chữa cháy</label>

											<label><input type="checkbox" name="language_speciality[]" value="Cứu hộ">
												Cứu hộ</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]" value="Hội họa">
												Hội họa</label>

											<label><input type="checkbox" name="language_speciality[]" value="Đồ họa">
												Đồ họa</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Thiết kế đồ họa"> Thiết kế đồ họa</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Điêu khắc"> Điêu khắc</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Lý luận, lịch sử và phê bình mỹ thuật"> Lý luận, lịch sử và
												phê bình mỹ thuật</label>

											<label><input type="checkbox" name="language_speciality[]" value="Gốm">
												Gốm</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Giáo dục thể chất"> Giáo dục thể chất</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Huấn luyện thể thao"> Huấn luyện thể thao</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Y sinh học thể dục thể thao"> Y sinh học thể dục thể
												thao</label>
									...
									<div class="group-language">
										...
										<div class="item">
											...
											<label><input type="checkbox" name="language_speciality[]"
													value="Sáng tác âm nhạc"> Sáng tác âm nhạc</label>

											<label><input type="checkbox" name="language_speciality[]"
													value="Thanh nhạc"> Thanh nhạc</label>
									...
									<div class="group-language">
										...
										<div class="item">
											<label><input type="checkbox" name="language_speciality[]" value="Khác">
												Khác</label>
										</div>
									</div>
								</div>
					...
					<div class="col-lg-3 page_ctv_step_14" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<input type="text" class="page_ctv_form_input" name="translation_software_name"
								placeholder="Ví dụ: Dịch thuật trados">
						</div>
					</div>
					<div class="col-lg-3 page_ctv_step_15" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<div class="custom_dropdown live_translate_select">
								<div class="custom_dropdown_button">Chọn tùy chọn</div>
								<div class="custom_dropdown_menu">
									<label><input type="checkbox" class="live_translate_select[]"
											value="Phiên dịch cabin"> Phiên dịch cabin</label>
									<label><input type="checkbox" class="live_translate_select[]"
											value="Phiên dịch song song"> Phiên dịch song song</label>
									<label><input type="checkbox" class="live_translate_select[]"
											value="Các loại hình khác"> Các loại hình khác</label>
								</div>
...
- Năm 2020 v.v."></textarea>
						...
						<div class="page_ctv_form_group">
							...
							<div class="page_ctv_form_group page_ctv_form_group_info_17">
								<div class="page_ctv_form_group_item">
									...
									<input type="text" class="page_ctv_form_input" name="info_17_province"
										placeholder="VD: Tỉnh Vĩnh Phúc, TP Hà Nội">
								</div>
								<div class="page_ctv_form_group_item">
									<label for="" class="page_ctv_form_label">
										Phòng tư pháp thuộc quận huyện nào?
									</label>
									<input type="text" class="page_ctv_form_input" name="info_17_district"
										placeholder="VD: Huyện Bình Xuyên, Quận Đống Đa">
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-6 page_ctv_step_18" style="display:none;">
						<div class="page_ctv_form_group">
							...
							<div class="page_ctv_form_note">
								(Nếu cộng tác với nhiều phòng thì ghi ngắn gọn và cách nhau bởi dấu phẩy, vd: Phòng công
								chứng tư Ulytan)
							</div>
							<div class="page_ctv_form_group page_ctv_form_group_info_18">
								<div class="page_ctv_form_group_item">
									...
									<input type="text" class="page_ctv_form_input" name="info_18_province"
										placeholder="VD: Tỉnh Vĩnh Phúc, TP Hà Nội">
								</div>
								<div class="page_ctv_form_group_item">
									<label for="" class="page_ctv_form_label">
									...
									<input type="text" class="page_ctv_form_input" name="info_18_district"
										placeholder="VD: Huyện Bình Xuyên, Quận Đống Đa">
								</div>
							</div>
						</div>
					...
					<div class="col-12 page_ctv_step_19" style="display:none;">
						<div class="page_ctv_form_group_file">
							...
							<div class="page_ctv_form_group mb-4">
								...
								<input type="file" name="upload_file_1" class="page_ctv_form_upload_file"
									accept=".doc,.docx,.pdf">
							</div>
							<div class="page_ctv_form_group">
								<label for="" class="page_ctv_form_label">
									Gửi cho chúng tôi hồ sơ bản scan của bạn bao gồm 1.Bằng (Nếu có), 2.Chứng minh thư,
									3. CV:
								</label>
								<input type="file" name="upload_file_2" class="page_ctv_form_upload_file"
									accept=".doc,.docx,.pdf">
							</div>
						</div>
					</div>
...
<div class="modal modal_lien_he fade" id="modal_lien_he" tabindex="-1" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
